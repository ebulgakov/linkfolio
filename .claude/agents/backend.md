...
- No ORM yet. When schema work starts, set up **Drizzle** (per `.claude/skills/neon-postgres/SKILL.md` guidance): schema files + generated migrations, no ad hoc SQL migrations.

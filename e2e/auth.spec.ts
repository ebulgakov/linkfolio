...
// the e2e-test branch is still fully isolated/reset). Run
// `pnpm cleanup:e2e-users` periodically (dry-run by default) to remove them —
// see scripts/cleanup-e2e-users.mjs. True isolation would require a separate
// Neon project (own Neon Auth provisioning) — deliberately not done, see
// PR #55 discussion.
